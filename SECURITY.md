...
RustAgents is an agent orchestration framework. Security-sensitive areas
...
RustAgents is pre-1.0. Security fixes target the `main` branch until the project
...
- dependency vulnerabilities with a practical exploit path in RustAgents
...
- vulnerabilities in downstream applications that use RustAgents incorrectly

## Security Design Direction

RustAgents should treat generated workflow source as untrusted. Declarative
