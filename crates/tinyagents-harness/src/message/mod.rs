...
impl Message {
    ...
    /// [`crate::tool::ToolResult`], which carries the flag across.
    ...
    /// Folds a [`crate::tool::ToolResult`] into the transcript message
    ...
    ///
    /// [`ToolResult::raw`][crate::tool::ToolResult::raw] is carried
    ...
    /// artifact.
    pub fn tool_from_result(result: &crate::tool::ToolResult) -> Self {
        Message::Tool(ToolMessage {
    ...
    /// [`ToolResult`][crate::tool::ToolResult] set no `raw` payload.
    ...
    /// tripped [`SummarizationPolicy::should_summarize`][crate::summarization::SummarizationPolicy::should_summarize],
