...
pub struct ToolMessage {
    ...
    /// [`ToolResult::raw`][crate::tool::ToolResult::raw] by
    ...
    ///
    /// [`ToolResult::mark_trusted_verbatim`][crate::tool::ToolResult::mark_trusted_verbatim]
    /// records its opt-in *inside* `raw` under
    /// [`TRUSTED_VERBATIM_KEY`][crate::tool::TRUSTED_VERBATIM_KEY], so
