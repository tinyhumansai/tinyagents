...
pub struct ModelResponse {
    ...
    /// [`RunLimits::max_model_calls`](crate::runtime::RunLimits) — it
    ...
    /// [`ResponseCache`][crate::cache::ResponseCache] rather than
...
pub struct ProviderError {
    ...
    /// [`retry_after_hint`][crate::retry::retry_after_hint] reads this
...
pub trait ChatModel<State: Send + Sync>: Send + Sync {
    ...
    /// cache key by
    /// [`scoped_cache_key`][crate::cache::scoped_cache_key].
    ///
    ...
    ///   [`model_cache_identity`][crate::cache::model_cache_identity]).
