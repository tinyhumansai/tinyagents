...
//! and [`crate::diagnostic::Diagnostic`] carries. It records both the
//! byte range it covers (`start..end`, the source-of-truth used to slice
//! snippets through a [`crate::source::SourceFile`]) and the 1-based
...
/// [`crate::source::SourceFile`] to slice the offending source); the
