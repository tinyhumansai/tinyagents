...
pub struct ParallelOptions {
    ...
    /// returns [`TinyAgentsError::Timeout`][tinyagents_harness::error::TinyAgentsError::Timeout]
    ...
    /// and returns [`TinyAgentsError::Cancelled`][tinyagents_harness::error::TinyAgentsError::Cancelled],
    /// dropping remaining in-flight work.
    pub cancellation: Option<tinyagents_harness::cancel::CancellationToken>,
}
...
impl ParallelOptions {
    ...
    pub fn with_cancellation(
        mut self,
        token: tinyagents_harness::cancel::CancellationToken,
    ) -> Self {
